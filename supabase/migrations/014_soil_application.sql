-- =============================================================================
-- 014: Direct soil fertilizer application (non-drip)
...
GRANT USAGE, SELECT ON SEQUENCE soil_application_events_id_seq TO authenticated;
GRANT USAGE, SELECT ON SEQUENCE soil_application_products_id_seq TO authenticated;

ALTER TABLE public.soil_application_events ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS soil_application_events_own ON public.soil_application_events;
...
DROP POLICY IF EXISTS soil_application_products_own ON public.soil_application_products;
